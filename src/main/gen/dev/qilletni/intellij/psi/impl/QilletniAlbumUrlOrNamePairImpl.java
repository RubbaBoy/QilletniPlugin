...
public class QilletniAlbumUrlOrNamePairImpl extends QilletniPsiElementBase implements QilletniAlbumUrlOrNamePair {

  public QilletniAlbumUrlOrNamePairImpl(@NotNull ASTNode node) {
    super(node);
  }
