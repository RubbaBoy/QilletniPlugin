...
public class QilletniImmutablePostfixExprSuffixImpl extends QilletniPsiElementBase implements QilletniImmutablePostfixExprSuffix {

  public QilletniImmutablePostfixExprSuffixImpl(@NotNull ASTNode node) {
    super(node);
  }
