...
public class QilletniSingleWeightImpl extends QilletniPsiElementBase implements QilletniSingleWeight {

  public QilletniSingleWeightImpl(@NotNull ASTNode node) {
    super(node);
  }
