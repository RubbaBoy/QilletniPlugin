...
public class QilletniCollectionUrlOrNamePairImpl extends QilletniPsiElementBase implements QilletniCollectionUrlOrNamePair {

  public QilletniCollectionUrlOrNamePairImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QilletniVisitor visitor) {
    visitor.visitCollectionUrlOrNamePair(this);
  }
