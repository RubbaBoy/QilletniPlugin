...
public class QilletniSongUrlOrNamePairImpl extends QilletniPsiElementBase implements QilletniSongUrlOrNamePair {

  public QilletniSongUrlOrNamePairImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QilletniVisitor visitor) {
    visitor.visitSongUrlOrNamePair(this);
  }
