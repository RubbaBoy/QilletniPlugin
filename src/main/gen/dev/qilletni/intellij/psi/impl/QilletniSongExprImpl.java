...
public class QilletniSongExprImpl extends QilletniPsiElementBase implements QilletniSongExpr {

  public QilletniSongExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public QilletniSongUrlOrNamePair getSongUrlOrNamePair() {
    return findChildByClass(QilletniSongUrlOrNamePair.class);
  }
