...
public class QilletniFunctionOnTypeImpl extends QilletniPsiElementBase implements QilletniFunctionOnType {

  public QilletniFunctionOnTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
