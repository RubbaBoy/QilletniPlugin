...
public class QilletniEntityInitializeImpl extends QilletniPsiElementBase implements QilletniEntityInitialize {

  public QilletniEntityInitializeImpl(@NotNull ASTNode node) {
    super(node);
  }
